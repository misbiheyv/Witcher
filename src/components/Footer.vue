        ...
        <div class="footer _container">
            ...
            <ul class="footer__refs">
                <li><a href="http://#" target="_blank">
                    ...
                    <g opacity="0.8">
                    <path d="M21.5 11.5C20.9477 11.5 20.5 11.0523 20.5 10.5C20.5 9.94774 20.9477 9.5 21.5 9.5C22.0523 9.5 22.5 9.94774 22.5 10.5C22.4998 11.0523 22.0523 11.5 21.5 11.5Z" fill="white"/>
